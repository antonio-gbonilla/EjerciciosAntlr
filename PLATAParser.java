...
public class PLATAParser extends Parser {
	...
	public static final int
		...
		MENOR=24, DISTINTO=25, IGUAL_QUE=26, INT=27, FLOAT=28, STRING=29, ID=30, 
		LINE_COMMENT=31, COMMENT=32, WS=33;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"INT", "FLOAT", "STRING", "ID", "LINE_COMMENT", "COMMENT", "WS"
		};
	}
	...
	public final ProgramaContext programa() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 2014115842L) != 0) );
			setState(31);
			match(EOF);
			}
		}
	...
	public static class CondicionContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof PLATAVisitor ) return ((PLATAVisitor<? extends T>)visitor).visitCondicion(this);
			else return visitor.visitChildren(this);
		}
	}
